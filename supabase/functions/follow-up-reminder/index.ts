      ...
      if (template) {
        ...
        emailHtml = `
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
            ...
            <p>We noticed you haven't had a chance to complete your Deep Dive questionnaire for <strong>${lead.business_name || 'your business'}</strong> yet. No worries — we know you're busy!</p>
            <p>Your personalised proposal is just a few questions away:</p>
            <p style="text-align:center;margin:24px 0;">
              <a href="${deepDiveUrl}" style="background:#2563eb;color:#fff;padding:12px 28px;border-radius:6px;text-decoration:none;font-weight:bold;display:inline-block;">Complete Deep Dive</a>
            </p>
